//
//  RFDDirectManualListViewController.m
//  RolePlay
//
...
@interface RFDDirectManualListViewController ()
{
...
@implementation RFDDirectManualListViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"直接人工列表";
    [self initSubViews];
    [self.tableView registerClass:[RFDDirectManualListCell class] forCellReuseIdentifier:@"DirectManualListCell"];
}
- (void)initSubViews
{
    // navBar 右按钮
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    NSArray *titleName = @[@"工序名称",@"计费类型",@"组织"];
...
{
    RFDDirectManualListCell *cell = [tableView dequeueReusableCellWithIdentifier:@"DirectManualListCell"];
