//
//  RFDFriendDetailViewController.m
//  RolePlay
//
...
#import "RFDDetailInfoCell.h"
#import "RFDButtonCell.h"
@interface RFDFriendDetailViewController ()
@property (nonatomic, strong) NSMutableArray *data;
@end

@implementation RFDFriendDetailViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[RFDDetailInfoCell class] forCellReuseIdentifier:@"DetailInfoCell"];
    [self.tableView registerClass:[RFDButtonCell class] forCellReuseIdentifier:@"ButtonCell"];
    [self initTestData];
}
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([dic objectForKey:@"user"] != nil) {
        ...
        [(RFDDetailInfoCell *)cell setCellType: ([dic objectForKey:@"founction"] == nil ? TLDetailInfoCellLeft : TLDetailInfoCellRight)];
